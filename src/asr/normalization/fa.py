...
class FaNormalization:
    ...
    def normalize(
        ...
        *,
        ...
        map_arabic_chars = (
            self.map_arabic_chars if map_arabic_chars is None else map_arabic_chars
        )
        remove_diacritics = (
            self.remove_diacritics if remove_diacritics is None else remove_diacritics
        )
        ...
        collapse_spaces = (
            self.collapse_spaces if collapse_spaces is None else collapse_spaces
        )
        strip_controls = (
            self.strip_controls if strip_controls is None else strip_controls
        )
